...
var wobbleSpeed1 = 6, wobbleDist1 = 0.4;
...
function runGame(plans, Display) {
  function startLevel(n) {
    ...
    runLevel(new Level(plans[n]), Display, function(status) {
	  if (gameStatus == "lost" ){
		//
		var audio = new Audio('https://puu.sh/sao69/86b578851a.mp3');
			audio.play();
		startLevel(n);
	  }else if (n < plans.length - 1){
		//beat level
		var audio = new Audio('https://puu.sh/saf26/aef8ac9095.mp3');
			audio.play();
        startLevel(n + 1);
      }else{
		 //beat all levels
